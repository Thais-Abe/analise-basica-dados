...
select replace(nome,"A","") as nome_modificado, char_length(nome) as tamanho_nome, (char_length(nome) + (rand() * char_length(replace(nome,"A",""))) * cod_emp) as id_aleatorio from empregado;
